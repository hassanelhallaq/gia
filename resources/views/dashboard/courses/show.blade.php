                    ...
                    <div class="tab-menu-heading">
                        <div class="tabs-menu ">
                            ...
                            <ul class="nav panel-tabs">
                                <li><a href="#tab11" data-toggle="tab" class="d-flex active"> الكل  <i class="text-center text-purple cartTap  bg-purple-transparent  brround"></i></a></li>
                                <li><a href="#tab12" data-toggle="tab" class="d-flex"> اكسل <i class="text-center text-purple cartTap  bg-purple-transparent  brround"></i></a></li>
                                <li><a href="#tab13" data-toggle="tab" class="d-flex"> وورد <i class="text-center text-purple cartTap  bg-purple-transparent  brround"></i></a></li>
                                <li><a href="#tab14" data-toggle="tab" class="d-flex"> BDF <i class="text-center text-purple cartTap  bg-purple-transparent  brround"></i></a></li>
                            </ul>
                        </div>
                    </div>
