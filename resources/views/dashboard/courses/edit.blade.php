                    ...
                    <form role="form" action="" method="post" class="f1">
                        <!--open one pag    -->
                            ...
                            <div class="f1-buttons d-flex justify-content-between mt-5">
                                <div class="d-flex">
                                    <button class="btn btn-warning-gradient btn-with-icon btn-sm" type="button" onclick="performUpdate({{$course->id}})"> حفظ الاعدادات  <i class="bi bi-floppy"></i></button>
...
<script>
    function performUpdate(id) {
        ...
        formData.append('subject', document.getElementById('subject').files[0]);
