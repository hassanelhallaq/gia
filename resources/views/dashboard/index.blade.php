								...
								<div class="card-body">
									...
									<div class="demo-avatar-group">
										...
										<div class="main-img-user avatar-sm">
											<img alt="avatar" class="rounded-circle  mr-2" src="{{URL::asset('assets/img/faces/5.jpg')}}">
										</div>
										<div class="main-img-user avatar-sm">
										...
										<div class="main-img-user avatar-sm">
											<img  class="rounded-circle" src="{{URL::asset('assets/img/faces/5.jpg')}}">
										</div>
						...
						<div class="col-md-12 col-xl-4 col-xs-12 col-sm-12">
							<div class="card">
								<div class="card-body">
									...
									<hr>
									<span class="fs-14 text-muted">
										برنامج التسويق الرقمي هو أكثر البرامج نشاطا حاليا خلال تطبيقناالادراة تسجيل حضور الدورات الرقمية
									</span>
								    <hr>
									<div class="demo-avatar-group">

										<div class="main-img-user avatar-sm">
											<img  class="rounded-circle  mr-2" src="{{URL::asset('assets/img/faces/5.jpg')}}">
										</div>
										<div class="main-img-user avatar-sm">
											<img  class="rounded-circle" src="{{URL::asset('assets/img/faces/4.jpg')}}">
										</div>
										<div class="main-img-user avatar-sm">
											<img alt="avatar" class="rounded-circle" src="{{URL::asset('assets/img/faces/4.jpg')}}">
										</div>
						...
						<div class="col-md-12 col-xl-4 col-xs-12 col-sm-12">
							<div class="card">
								<div class="card-body">
									...
									<hr>
									<span class="fs-14 text-muted">
										برنامج التسويق الرقمي هو أكثر البرامج نشاطا حاليا خلال تطبيقنالادراة تسجيل حصور الدورات الرقمية.
									</span>
								    <hr>
									<div class="demo-avatar-group">
