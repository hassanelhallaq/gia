    ...
    <div class="main-sidemenu">
        <div class="h-100 flex-column  d-inline-flex justify-content-between">
            <ul class="side-menu pos-absolutee top-0 start-0">
                ...
                @can('اضافه مشروع')
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide"  href="#"><i class="si si-people tx-22"></i><span class="side-menu__label mr-3">   candidate</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">
                        <li><a class="slide-item" href="{{ route('candidate.index') }}"> اضافة </a></li>
