    ...
    <header>
       <div class="wrap">
        <div class="sub_header">
            <div class="mh-logo">
                <img src="{{asset('landingPage/assets/mh-logo 1.png')}}" alt="">

            </div>
            <div class="logo2">
                <img src="{{asset('landingPage/assets/logo2.png')}}" alt="">
            </div>
        </div>
        <div class="navigation">
            <div class="list_nav">
                <ul>
                  <li class="nav_items"><a class="c-gn" href="{{route('home')}}" data-translate="home">الرئيسية</a></li>
                  <li class="nav_items"><a href="{{route('timeLine')}}" data-translate="timeline">الجدول الزمني</a></li>
