...
<style>
    /* use  green / red  / blue  for the span status to controle the status of card */
    .card span {
        border: 1px solid rgba(22, 68, 194, 0.24);
        border-radius: 15px;
        padding: 5px 8px;
    }
    ...
    .card .green {
        color: #119F4A;
        background: rgba(17, 159, 74, 0.06);
    }
    ...
    .card .red {
        background-color: rgba(194, 22, 22, 0.06);
        color: #C21616;
    }
    ...
    .card .blue {
        background-color: rgba(22, 68, 194, 0.06);
        color: #1644C2;
    }
</style>
                ...
                <div class="df ai-c" id="open_menu">
                    ...
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                        ...
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            ...
                            stroke="#1644C2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            ...
                            @if ($quiz)
                                <div class="df ai-c">
                                    <div class="flex-g btn_download g0">
                                        <p>تقدم للأختبار</p>
                                        <a href="{{ route('quiz.view', ['quizId' => $quiz->quiz_id, 'clientId' => $attendance->id]) }}"
                                            data-translate="submit">&#10140;
                                        <svg href="{{ route('quiz.view', ['quizId' => $quiz->quiz_id, 'clientId' => $attendance->id]) }}" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M6.32398 4.44557C6.52395 4.25512 6.53167 3.93863 6.34123 3.73867C6.15078 3.5387 5.83429 3.53098 5.63433 3.72143L6.32398 4.44557ZM2.57183 6.63809C2.37186 6.82854 2.36414 7.14503 2.55459 7.34499C2.74503 7.54496 3.06152 7.55267 3.26148 7.36223L2.57183 6.63809ZM3.26148 6.63809C3.06152 6.44765 2.74503 6.45537 2.55459 6.65533C2.36414 6.8553 2.37186 7.17179 2.57183 7.36223L3.26148 6.63809ZM5.63433 10.2789C5.83429 10.4693 6.15078 10.4616 6.34123 10.2617C6.53167 10.0617 6.52395 9.7452 6.32398 9.55476L5.63433 10.2789ZM2.91666 6.50016C2.64051 6.50016 2.41666 6.72402 2.41666 7.00016C2.41666 7.27631 2.64051 7.50016 2.91666 7.50016V6.50016ZM11.0833 7.50016C11.3595 7.50016 11.5833 7.27631 11.5833 7.00016C11.5833 6.72402 11.3595 6.50016 11.0833 6.50016V7.50016ZM5.63433 3.72143L2.57183 6.63809L3.26148 7.36223L6.32398 4.44557L5.63433 3.72143ZM2.57183 7.36223L5.63433 10.2789L6.32398 9.55476L3.26148 6.63809L2.57183 7.36223ZM2.91666 7.50016H11.0833V6.50016H2.91666V7.50016Z"
                                                fill="#1644C2" />
                                        </svg></a>
                                    </div>
                                </div>
                        ...
                        @if ($quizAttenAfter == null)
                            @if ($course->status_after == 'active' && $quizAfter)
                                <div class="df ai-c">
                                    <div class="flex-g btn_download g0">
                                        <p>تقدم للأختبار</p>
                                        <a href="{{ route('quiz.view', ['quizId' => $quizAfter->quiz_id, 'clientId' => $attendance->id]) }}"
                                            data-translate="submit">&#10140;
                                            <svg href="{{ route('quiz.view', ['quizId' => $quizAfter->quiz_id, 'clientId' => $attendance->id]) }}" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <path
                                                    d="M6.32398 4.44557C6.52395 4.25512 6.53167 3.93863 6.34123 3.73867C6.15078 3.5387 5.83429 3.53098 5.63433 3.72143L6.32398 4.44557ZM2.57183 6.63809C2.37186 6.82854 2.36414 7.14503 2.55459 7.34499C2.74503 7.54496 3.06152 7.55267 3.26148 7.36223L2.57183 6.63809ZM3.26148 6.63809C3.06152 6.44765 2.74503 6.45537 2.55459 6.65533C2.36414 6.8553 2.37186 7.17179 2.57183 7.36223L3.26148 6.63809ZM5.63433 10.2789C5.83429 10.4693 6.15078 10.4616 6.34123 10.2617C6.53167 10.0617 6.52395 9.7452 6.32398 9.55476L5.63433 10.2789ZM2.91666 6.50016C2.64051 6.50016 2.41666 6.72402 2.41666 7.00016C2.41666 7.27631 2.64051 7.50016 2.91666 7.50016V6.50016ZM11.0833 7.50016C11.3595 7.50016 11.5833 7.27631 11.5833 7.00016C11.5833 6.72402 11.3595 6.50016 11.0833 6.50016V7.50016ZM5.63433 3.72143L2.57183 6.63809L3.26148 7.36223L6.32398 4.44557L5.63433 3.72143ZM2.57183 7.36223L5.63433 10.2789L6.32398 9.55476L3.26148 6.63809L2.57183 7.36223ZM2.91666 7.50016H11.0833V6.50016H2.91666V7.50016Z"
                                                    fill="#1644C2" />
                ...
                <div class="df f-c g0">
                    ...
                    @if ($attendance)
                        @if ($attendance->email == null)
                            <span class="status red">
                                <svg class="circle" width="8" height="9" viewBox="0 0 8 9" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="4" cy="4.5" r="4" />
                                </svg>
                                لم يتم التقديم على نموذج
                            </span>
                        @else
                            <span class="status red">
                                <svg class="circle" width="8" height="9" viewBox="0 0 8 9" fill="none"
                ...
                @if ($attendance)
                    @if ($attendance->email == null)
                        <div class="df ai-c">
                            <div class="flex-g btn_download g0">
                                <p>تقدم لنموذج</p>
                                <a href="{{ route('Certificate_Issuance_form', [$attendance->id, request()->course_id]) }}"
                                    data-translate="submit">
                                    <svg href="{{ route('Certificate_Issuance_form', [$attendance->id, request()->course_id]) }}" width="14" height="14" viewBox="0 0 14 14" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M6.32398 4.44557C6.52395 4.25512 6.53167 3.93863 6.34123 3.73867C6.15078 3.5387 5.83429 3.53098 5.63433 3.72143L6.32398 4.44557ZM2.57183 6.63809C2.37186 6.82854 2.36414 7.14503 2.55459 7.34499C2.74503 7.54496 3.06152 7.55267 3.26148 7.36223L2.57183 6.63809ZM3.26148 6.63809C3.06152 6.44765 2.74503 6.45537 2.55459 6.65533C2.36414 6.8553 2.37186 7.17179 2.57183 7.36223L3.26148 6.63809ZM5.63433 10.2789C5.83429 10.4693 6.15078 10.4616 6.34123 10.2617C6.53167 10.0617 6.52395 9.7452 6.32398 9.55476L5.63433 10.2789ZM2.91666 6.50016C2.64051 6.50016 2.41666 6.72402 2.41666 7.00016C2.41666 7.27631 2.64051 7.50016 2.91666 7.50016V6.50016ZM11.0833 7.50016C11.3595 7.50016 11.5833 7.27631 11.5833 7.00016C11.5833 6.72402 11.3595 6.50016 11.0833 6.50016V7.50016ZM5.63433 3.72143L2.57183 6.63809L3.26148 7.36223L6.32398 4.44557L5.63433 3.72143ZM2.57183 7.36223L5.63433 10.2789L6.32398 9.55476L3.26148 6.63809L2.57183 7.36223ZM2.91666 7.50016H11.0833V6.50016H2.91666V7.50016Z"
                                            fill="#1644C2" />
    ...
    <nav>
        <div class="main_nav">
            <div id="home " class="home">
                <a href="{{ route('invitationV2.second', [$attendance->id, request()->course_id]) }}"
                    class=" df f-c ai-c"> <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M18.367 16.3321L18.373 10.5391L14.25 6.42908C13.0057 5.19031 10.9942 5.19031 9.74999 6.42908L5.63599 10.5291V16.3291C5.6393 18.0833 7.06377 19.5028 8.81799 19.5001H15.185C16.938 19.5029 18.362 18.0851 18.367 16.3321Z"
                            stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            d="M19.124 6.51807C19.124 6.10385 18.7882 5.76807 18.374 5.76807C17.9598 5.76807 17.624 6.10385 17.624 6.51807H19.124ZM18.374 10.5391H17.624C17.624 10.7384 17.7033 10.9295 17.8445 11.0702L18.374 10.5391ZM19.4705 12.6912C19.7638 12.9837 20.2387 12.9829 20.5311 12.6896C20.8236 12.3962 20.8229 11.9214 20.5295 11.6289L19.4705 12.6912ZM6.16552 11.0602C6.45886 10.7678 6.45959 10.2929 6.16714 9.99955C5.8747 9.70621 5.39982 9.70548 5.10648 9.99793L6.16552 11.0602ZM3.47048 11.6289C3.17714 11.9214 3.17641 12.3962 3.46886 12.6896C3.7613 12.9829 4.23618 12.9837 4.52952 12.6912L3.47048 11.6289ZM13.25 19.5001C13.25 19.9143 13.5858 20.2501 14 20.2501C14.4142 20.2501 14.75 19.9143 14.75 19.5001H13.25ZM9.25 19.5001C9.25 19.9143 9.58579 20.2501 10 20.2501C10.4142 20.2501 10.75 19.9143 10.75 19.5001H9.25ZM17.624 6.51807V10.5391H19.124V6.51807H17.624ZM17.8445 11.0702L19.4705 12.6912L20.5295 11.6289L18.9035 10.0079L17.8445 11.0702ZM5.10648 9.99793L3.47048 11.6289L4.52952 12.6912L6.16552 11.0602L5.10648 9.99793ZM14.75 19.5001V17.7201H13.25V19.5001H14.75ZM14.75 17.7201C14.75 16.2013 13.5188 14.9701 12 14.9701V16.4701C12.6904 16.4701 13.25 17.0297 13.25 17.7201H14.75ZM12 14.9701C10.4812 14.9701 9.25 16.2013 9.25 17.7201H10.75C10.75 17.0297 11.3096 16.4701 12 16.4701V14.9701ZM9.25 17.7201V19.5001H10.75V17.7201H9.25Z"
                            fill="white" />
                    </svg>
                    الرئيسية
                </a>
        ...
        <div class="sub_nav">
            ...
            <div id="activity">
                <a href="{{ route('invitationV2.third', [$attendance->id, request()->course_id]) }}"
                    class=" df f-c ai-c"> <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                        xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd" clip-rule="evenodd"
                            d="M3.66663 8.66683V7.3335C3.66663 5.12436 5.45749 3.3335 7.66663 3.3335H8.99996C11.2091 3.3335 13 5.12436 13 7.3335V8.66683C13 10.876 11.2091 12.6668 8.99996 12.6668H7.66663C5.45749 12.6668 3.66663 10.876 3.66663 8.66683Z"
                            stroke="#265AE8" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            d="M6.99994 6.42621C6.99994 5.69955 7.59994 5.29955 8.49794 5.33355C9.146 5.35602 9.66128 5.88512 9.66661 6.53355C9.69795 7.1399 9.4106 7.71866 8.90861 8.06021C8.48191 8.33355 8.25639 8.83268 8.33327 9.33355"
                            stroke="#265AE8" stroke-linecap="round" stroke-linejoin="round" />
                        <path
                            d="M8.33327 11.0002C8.14947 11.0002 7.99994 10.8506 7.99994 10.6668C7.99994 10.483 8.14947 10.3335 8.33327 10.3335C8.51707 10.3335 8.66661 10.483 8.66661 10.6668C8.66661 10.8506 8.51707 11.0002 8.33327 11.0002Z"
                            fill="#265AE8" />
                        <path
                            d="M8.33329 10C8.70148 10 8.99996 10.2985 8.99996 10.6667C8.99996 11.0349 8.70148 11.3333 8.33329 11.3333C7.96511 11.3333 7.66663 11.0349 7.66663 10.6667C7.66663 10.2985 7.96511 10 8.33329 10Z"
                            fill="#265AE8" />
                    </svg>
                    الأنشطة
                </a>
