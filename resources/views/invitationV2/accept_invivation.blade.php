        ...
        <div class="container">
            ...
            <div id="timePlace" class="flex-g g0 ai-c ">
                <div class="df ai-c">
                    ...
                    {{-- <p id="place_content">{{ $course->location }}</p> --}}
                    ...
                    <span>
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            <path fill-rule="evenodd" clip-rule="evenodd"
                                ...
                                stroke="black" stroke-linecap="round" stroke-linejoin="round" />
                            <path d="M10.9106 10.1636V13.5756H14.1776" stroke="black" stroke-linecap="round"
...
<script>
    ...
    function showSlide(index) {
        ...
        // Update title
        document.getElementById('title_slider').textContent = titles[currentIndex];

        // Update SVG image
        document.getElementById('svg-image').src = "{{ asset('') }}" + svgPaths[currentIndex];
