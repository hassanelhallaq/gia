...
>>>>>>> b7832de3b10c1956cbe6ee09afe2b6b2707b41f1
}
...
function startTimerLine(time){
    var widthValue=document.body;
    if(widthValue.offsetWidth>500){
    ...
    function timer(){
        ...
        if(time > quiz_box.offsetWidth-1){ //if time value is greater than 549
            clearInterval(counterLine); //clear counterLine
        }
    }
}
